...
public class LostItem extends AppCompatActivity {
    ...
    //----------------------------------- Button Click -----------------------------------------------
    public void Click_Lpost(View view)
    {
        EditText ed1 = (EditText) findViewById(R.id.lost_title);
        EditText ed2 = (EditText) findViewById(R.id.lost_desc);
        EditText ed3 = (EditText) findViewById(R.id.lost_keywords);
        EditText ed5 = (EditText) findViewById(R.id.lost_contact);
        ...
        else
        {
            ...
            Toast.makeText(LostItem.this, "Current: "+ currentDateTimeString, Toast.LENGTH_SHORT).show();
            CallVolley();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode== 1234 && resultCode == RESULT_OK && data != null && data.getData() != null)
        {
            ...
            try
            {
                ...
                ImageView imageView = (ImageView) findViewById(R.id.lost_img1);
    ...
    {
        final ProgressDialog loading = ProgressDialog.show(LostItem.this,"Posting...","Please wait...",false,false);
        RequestQueue queue = Volley.newRequestQueue(LostItem.this);
        String UPLOAD_URL = getString(R.string.ip)+"/LOST_AND_FOUND/PostLostItem.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String r) {
                        ...
                        {
                            Intent i = new Intent (LostItem.this, Home.class);
                            startActivity(i);
                        }
                        else{
                            Toast.makeText(LostItem.this, "Incorrect inputs",Toast.LENGTH_LONG).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(LostItem.this, "Error: " +volleyError,Toast.LENGTH_LONG).show();
                        loading.dismiss();
            ...
            protected java.util.Map<String, String> getParams() throws AuthFailureError {
                ...
                if (bitmap1 == null)
                {
                    runOnUiThread(new Runnable(){
                        public void run(){
                            ...
                            imageV = (ImageView) findViewById(R.id.lost_img1);
                ...
                params.put("KEY_STATUS", "LOST");

                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(LostItem.this);
